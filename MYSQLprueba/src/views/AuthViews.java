...
public class AuthViews {
	...
	public void login() {
       ...
       public void registro() {
          ...
          // registerButton.setForeground(Color.WHITE);
           ...
           registerButton.addActionListener( new ActionListener() {
	        ...
	        AuthModels model = new AuthModels();
	        boolean resultado = model.guardarUsuario(username, bio, preferencias, username + "Zahir", "1234", colonia); // Ajusta email y contraseña reales
       ...
       protected void router(String destino) {
           if (destino.equalsIgnoreCase("Login")) {
               login();
           } else if (destino.equalsIgnoreCase("Registro")) {
               registro();
           }
       }
   }